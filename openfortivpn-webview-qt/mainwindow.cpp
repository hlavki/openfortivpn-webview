...
MainWindow::MainWindow(const bool keepOpen,
    ...
    webEnginePage(new QWebEnginePage(webEngineProfile, parent)),
    ...
    keepOpen(keepOpen)
{
    ...
    QObject::connect(&webEnginePage, &QWebEnginePage::certificateError, [](QWebEngineCertificateError e) { e.acceptCertificate(); });
}
